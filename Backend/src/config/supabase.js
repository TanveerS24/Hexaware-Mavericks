...
const inMemoryStore = {
  ...
  complaints: [
    ...
    },
    {
      id: 'comp-104',
      citizen_id: 'citizen-1',
      title: 'Main pipeline leakage near City Central Metro',
      description: 'Severe water pipe leakage near metro gate 2. Potable water flooding footpath since morning.',
      department: 'Water & Sewerage',
      ...
      sentiment: 'distressed',
      sentiment_score: 0.8,
      ai_summary: 'Potable water pipe broken and leaking on pedestrian pathway near Metro.',
      address: 'City Central Metro Gate 2',
      region: 'City Central',
      sla_started_at: new Date(Date.now() - 900000).toISOString(),
      sla_deadline: new Date(Date.now() + 23 * 3600000).toISOString(),
